...
[assembly: ExportEffect(typeof(SeatMaker.Droid.TouchEffect), "TouchEffect")]

namespace SeatMaker.Droid
{
    using FormsTouchEffect = SeatMaker.Views.Touch.TouchEffect;

    public class TouchEffect : PlatformEffect
    {
        Android.Views.View view;
        Element formsElement;
        FormsTouchEffect libTouchEffect;
        bool capture;
        ...
        protected override void OnAttached()
        {
            ...
            FormsTouchEffect touchEffect =
                (FormsTouchEffect)Element.Effects.
                    FirstOrDefault(e => e is FormsTouchEffect);
